                    ...
                    if (data[i].estado == "1") {
                        ...
                        for (var j = 0; j < data.length; j++) {
                            ...
                            if (data[j].estado == "2" && data[j].idCargo == codigo) {
                                ...
                                var TiempoCargado = horas.toString() + "H " + MinutosR.toString() +"M " ;
                        ...
                        temp += "<div ><i class='fa fa-user' aria-hidden='true'></i>" + data[i].nombre + "</a><a class='text-right'><div class='text-right'>" + "   " + TiempoCargado + "</div></div>";
                        temp += "</a>";
                        temp += "</h4>";
                        temp += "</div>";
